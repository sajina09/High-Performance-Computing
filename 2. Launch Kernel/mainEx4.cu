...
// Indexing the macro for 2D Matrices -> converts matrix index into a 1D array because CUDA memory is flat
...
// Difference between add_v1 and add_v2 is blockIdx.x and blockIdx.y are swapped.
